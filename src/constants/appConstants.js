...
export const IMPORTANCE_LEVELS_ARRAY = [ // For Dropdowns
    { label: 'Important', value: IMPORTANCE_LEVELS_MAP.IMPORTANT }, { label: 'Must Have', value: IMPORTANCE_LEVELS_MAP.MUST_HAVE },
    { label: 'Very Important', value: IMPORTANCE_LEVELS_MAP.VERY_IMPORTANT }, { label: 'Nice to Have', value: IMPORTANCE_LEVELS_MAP.NICE_TO_HAVE },
...
// In src/constants/appConstants.js
export const RATING_OPTIONS_ARRAY = [ // For PropertyForm rating dropdown
    { label: 'Not Rated', value: RATING_VALUES_MAP.NOT_RATED },
    // VVV Remove numbers from labels VVV
...
// --- Property Form Related Dropdowns etc. ---
export const PROPERTY_STATUS_OPTIONS = [ { label: 'Select Status...', value: null }, { label: 'Researching', value: 'researching' }, { label: 'Viewing Scheduled', value: 'viewingScheduled' }, { label: 'Visited - Interested', value: 'visitedInterested' }, { label: 'Visited - Not Interested', value: 'visitedNotInterested' }, { label: 'Offer Made', value: 'offerMade' }, { label: 'Under Contract', value: 'underContract' }, { label: 'Rejected / Lost', value: 'rejectedLost' }, { label: 'Archived', value: 'archived' }];
export const BEDROOM_OPTIONS = [ { label: 'Any', value: null }, { label: '1', value: 1 }, { label: '2', value: 2 }, { label: '3', value: 3 }, { label: '4', value: 4 }, { label: '5', value: 5 }, { label: '6+', value: 6 }];
export const BATHROOM_OPTIONS = [ { label: 'Any', value: null }, { label: '1', value: 1 }, { label: '1.5', value: 1.5 }, { label: '2', value: 2 }, { label: '2.5', value: 2.5 }, { label: '3', value: 3 }, { label: '3.5', value: 3.5 }, { label: '4+', value: 4 }];
export const GARAGE_OPTIONS = [ { label: 'Any', value: null }, { label: 'None', value: 0 }, { label: '1 Car', value: 1 }, { label: '2 Cars', value: 2 }, { label: '3+ Cars', value: 3 }];
